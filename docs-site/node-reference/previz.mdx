---
title: "3D Director"
description: "A previz blocking stage: place low-poly actors on a ground plane, run them along paths, cut between camera shots, then capture stills or record the whole sequence as camera/blocking reference for video models."
sidebarTitle: "3D Director"
---

<Frame caption="3D Director · screenshot coming soon">
  <img src="/images/nodes/_placeholder.svg" alt="3D Director" />
</Frame>
